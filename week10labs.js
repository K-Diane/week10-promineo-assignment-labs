 ...
 *    example:    myForm.style.backgroiung = ''
 *
...
myForm.style.backgroundColor = "#DBF9FC";
...
myTdEmail = document.createElement("td");
...
myTable.style.border = "5px solid black";
...
myButton.addEventListener("click", () => {
  document.body.style.backgroundcolor = `rdb(${Math.random() * 255},${
    Math.random() * 255
  },${Math.random() * 255})`;
});
